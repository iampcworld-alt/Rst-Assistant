...
def show_admin_login_page():
    ...
    with col2:
        str_app.markdown(html_block('<div class="glass-card" style="text-align:center;">'), unsafe_allow_html=True)
        render_logo("🔒 Admin Access import streamlit as str_app
import edge_tts
import asyncio
import sqlite3
import textwrap
...
def show_admin_login_page():
    ...
    with col2:
        ...
        str_app.markdow             linear-gradient(135deg, {accent_a}, {accent_b}, {accent_c}) border-box;
    display: flex;
    align-items: center;
    justify-content: center;
    backdrop-filter: blur(10px);
